...
public class CinemaProjectStage4 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			if (menuInput == 1) {
				...
				// buy ticket and select seat
				System.out.println("Enter a row number: ");
				int rowNumber = scan.nextInt();
				
				while (rowNumber < 1 || rowNumber > row) {
					System.out.println("Enter a row number: (1 - " + row + ")" );
				...
				while (seatNumber < 1 || seatNumber > numberOfSeat) {
					System.out.println("Enter a row number: (1 - " + numberOfSeat + ")" );
				...
				System.out.println();
				System.out.println("Please select following menu");
				System.out.println("1. Show the seats \n2. Buy a ticket \n0. Exit");
				menuInput = scan.nextInt();
			}
		}
